	...
	<script>
		...
		tinymce.init({
			...
			plugins: [
				...
				'code lists pagebreak quickbars wordcount filemanager fontawesome noneditable',
			],
			toolbar1: 'embed media image table | emoticons fontawesome hr insertdatetime charmap',
